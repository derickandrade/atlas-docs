...
<header>
	...
	<nav>
        <ul id="visible-menu">
			<li aria-label="Home Button"><a id="home" class="active-link" href="/" aria-current="page">Atlas</a></li>
			<li class="left-menu"><button>Pesquisar</button></li>
		</ul>
